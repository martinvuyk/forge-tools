...
struct SockFamily:
    ...
    none.
    """
    alias AF_USB = "AF_USB"  # TODO: implement
    """"AF_USB". Notes: This Address Family is not standard since there is
    none.
    """
    ...
    fn is_non_standard(self) -> Bool:
        return self._selected in (
            (Self.AF_SPI, Self.AF_I2C, Self.AF_UART, Self.AF_USB)
        )
